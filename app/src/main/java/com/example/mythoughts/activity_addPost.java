...
public class activity_addPost extends AppCompatActivity {
    ...
    private void uploadData(String title, String description) {
        ...
        pd.show();
        //here data will upload to firebase
        //time when user post
        final String timeStamp=String.valueOf(System.currentTimeMillis());
        //setting filepath for our image
        ...
        if(blog_image.getDrawable()!=null){
            ...
            //Now we will create the reference of storage in firebase
            ...
            ref.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if(uriTask.isSuccessful()){
                        ...
                        //Now we will upload data to firebase
                        ...
                        //Now we will put data to firebase
                        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Posts");
                        ref.child(timeStamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                pd.dismiss();
                                Toast.makeText(activity_addPost.this,"Post Publish",Toast.LENGTH_LONG).show();
                                title_blog.setText("");
                                description_blog.setText("");
                                blog_image.setImageURI(null);
                                image_uri=null;
                                startActivity(new Intent(activity_addPost.this,activity_home.class));
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                pd.dismiss();
                                Toast.makeText(activity_addPost.this,""+e.getMessage(),Toast.LENGTH_LONG).show();
                            }
                        });
